...
export const form =  {
 	"data": [{
 			...
 			"title": "Ich habe heute meine Routinemedikation(z.B. Asthmaspray) genommen"
 		},
 		{
 			"title": "Ich hatte Atembeschwerden auf einer Skala von 0-10. 0 Keine Beschwerden, 10 am Schlimmsten vorstellbar",
